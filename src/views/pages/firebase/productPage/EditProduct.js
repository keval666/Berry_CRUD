...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        if (editData !== null && typeof editData !== "undefined" && editData) {
            ...
            reset({ ...getValues(), "name": editData.name, "stock": editData.stock, "price": editData.price, "gst": editData.gst, })
        }
    }, [])
    ...
    const submit = async (e) => {
        ...
        if (e.name && e.stock && product.type && e.price && e.gst) {
            ...
            await CRUD.editData(editData.id, data, "Productlist");
            history(-1);
                ...
                <form onSubmit={handleSubmit(submit)} className="is-filled">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <input type="text" name="price" className="form-control" {...register('price', { required: true })} />
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="input-group input-group-outline my-3">
                                <button className="btn btn-success" onClick={() => setHide(type ? false : true)} type="submit" style={{ zIndex: '0' }}>Edit</button>
                            </div>
                        </div>
                    </div>
                </form>
